...
function Submit() {
   ...
   Name_Of_The_person_Array.push(Guest_name);
   document.getElementById("Display_names").innerHTML = Name_Of_The_person_Array;
   console.log(Name_Of_The_person_Array);
   var length_of_the_array = Name_Of_The_person_Array.length;
    console.log(length_of_the_array);
}
function Show_list() {
    var i = Name_Of_The_person_Array.join("<br>");
    console.log(Name_Of_The_person_Array);
...
function Search() {
    ...
    var found = 0;
    var j;
    for(j=0; j<Name_Of_The_person_Array.length; j++) {
        if(s==Name_Of_The_person_Array[j]) {
            found = found+1;
        }
    }
